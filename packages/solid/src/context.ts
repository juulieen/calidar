 ...
 *
 * Solid note: `active`/`unit` are accessor functions so reading them inside JSX
 * tracks correctly.
 */
...
export interface CalendarContextValue {
  ...
  resourcesActive: Accessor<boolean>;
  ...
  resourceView: Accessor<ResourceViewModel | null>;
