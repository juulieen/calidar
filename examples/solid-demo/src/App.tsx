/**
 * Calidar Solid demo: a full-screen calendar with a realistic event set
 * (recurring, all-day, multi-day and overlapping), per-resource bookings, a
 * large bulk set for the infinite agenda, a time-zone switcher and the built-in
 * view picker (including Resources and Timeline modes).
 */
    ...
    <div class="demo">
      <header class="demo__bar">
        ...
        <span class="demo__hint">
          ...
          Try the “Resources” view for per-room columns, or “Timeline” (Day /
          Week / Month) for a horizontal axis with rooms as rows — drag bars
          sideways to reschedule or onto another room.
        </span>
